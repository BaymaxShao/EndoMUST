...
import models.endomust as endomust
...
def evaluate(opt):
    ...
    if opt.ext_disp_to_eval is None:
        ...
        if opt.model_type == 'endomust':
            depther = endomust.endomust(
                backbone_size="base", r=opt.lora_rank, peft_type=opt.lora_type,
    ...
    with torch.no_grad():
        for i, data in tqdm(enumerate(dataloader)):
            ...
            if opt.visualize_depth and opt.eval_split == 'endovis':
            ...
            elif opt.visualize_depth and opt.eval_split == 'hamlyn':
                vis_pred_depth = render_depth(pred_disp)
